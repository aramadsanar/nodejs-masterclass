...
handlers.index = (data, callback) => {
    if (data.method == 'get') {
        ...
        var templateData = {
            ...
            'head.description': 'We offer free, simple uptime monitoring for HTTP and HTTPS Sites of all kinds. When your site goes down, you will be notified via SMS!',
            'body.class': 'index'
        }
...
handlers.accountDeleted = (data, callback) => {
    if (data.method == 'get') {
        //prepare data for interpolation
        var templateData = {
            'head.title': 'Deleted account',
            'head.description': 'The user had deleted their account!',
